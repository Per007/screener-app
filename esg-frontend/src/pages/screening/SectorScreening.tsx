  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mt-2">Sector Analysis</h1>
      </div>
      ...
      {results && (
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Sector Screening Results: {results.sector}</h2>
